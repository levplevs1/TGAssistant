...
{
    public class HealthcareQueryTestFixture : IDisposable
    {
        public TelegramBotDbContext Context;
        public IMapper Mapper;

        public HealthcareQueryTestFixture()
        {
    ...
    [CollectionDefinition("HealthcareQueryCollection")]
    public class QueryCollection : ICollectionFixture<HealthcareQueryTestFixture> { }
}
