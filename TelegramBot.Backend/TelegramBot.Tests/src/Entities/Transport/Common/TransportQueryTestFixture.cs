...
{
    public class TransportQueryTestFixture : IDisposable
    {
        public TelegramBotDbContext Context;
        public IMapper Mapper;

        public TransportQueryTestFixture()
        {
    ...
    [CollectionDefinition("TransportQueryCollection")]
    public class QueryCollection : ICollectionFixture<TransportQueryTestFixture> { }
}
