...
{
    public class Articles_Housing_CodeLookupDto : IMapWith<Domain.src.Entities.Articles_Housing_Code>
    {
        ...
        {
            profile.CreateMap<Domain.src.Entities.Articles_Housing_Code, Articles_Housing_CodeLookupDto>()
