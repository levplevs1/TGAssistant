...
{
    public class Payments_MethodDetailsVm : IMapWith<Domain.src.Entities.Payments_Method>
    {
        ...
        {
            profile.CreateMap<Domain.src.Entities.Payments_Method, Payments_MethodDetailsVm>()
