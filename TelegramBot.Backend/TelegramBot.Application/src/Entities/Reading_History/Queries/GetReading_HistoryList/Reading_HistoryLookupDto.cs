...
{
    public class Reading_HistoryLookupDto : IMapWith<Domain.src.Entities.Reading_History>
    {
        ...
        {
            profile.CreateMap<Domain.src.Entities.Reading_History, Reading_HistoryLookupDto>()
