...
{
    public class Quick_Answers_EducationDetailsVm : IMapWith<Domain.src.Entities.Quick_Answers_Education>
    {
        ...
        {
            profile.CreateMap<Domain.src.Entities.Quick_Answers_Education, Quick_Answers_EducationDetailsVm>()
