...
{
    public class Type_Of_RequestsLookupDto : IMapWith<Domain.src.Entities.Type_Of_Requests>
    {
        ...
        {
            profile.CreateMap<Domain.src.Entities.Type_Of_Requests, Type_Of_RequestsLookupDto>()
