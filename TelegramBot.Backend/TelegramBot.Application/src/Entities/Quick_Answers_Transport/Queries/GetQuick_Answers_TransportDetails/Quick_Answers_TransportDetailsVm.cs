...
{
    public class Quick_Answers_TransportDetailsVm : IMapWith<Domain.src.Entities.Quick_Answers_Transport>
    {
        ...
        {
            profile.CreateMap<Domain.src.Entities.Quick_Answers_Transport, Quick_Answers_TransportDetailsVm>()
