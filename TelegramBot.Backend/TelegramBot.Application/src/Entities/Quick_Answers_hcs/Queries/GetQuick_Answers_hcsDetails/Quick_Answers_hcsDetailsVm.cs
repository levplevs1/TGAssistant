...
{
    public class Quick_Answers_hcsDetailsVm : IMapWith<Domain.src.Entities.Quick_Answers_hcs>
    {
        ...
        {
            profile.CreateMap<Domain.src.Entities.Quick_Answers_hcs, Quick_Answers_hcsDetailsVm>()
